...
public class DBConfig {
	...
	public TransactionInterceptor transactionInterceptor() {
		...
		attribute.setName("*");
		attribute.setRollbackRules(Collections.singletonList(new RollbackRuleAttribute(Exception.class))); // 모든 Exception이 발생하면 동작
	...
	public Advisor advisor() {
		...
		*/
		...
		pointCut.setExpression("execution(* com.gdu.app08.service.*Impl.*Transaction(..))");  // service 패키지의 모든 Impl의 모든 Transaction 메소드 매개변수는 상관없음
