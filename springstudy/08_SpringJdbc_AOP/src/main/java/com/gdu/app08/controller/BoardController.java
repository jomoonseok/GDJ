...
public class BoardController {
	...
	public String remove(int board_no) {
		boardService.removeBoard(board_no); // remeveBoard()로부터 0/1이 반환되지만 처리하지 않았다.
		return "redirect:/brd/list";
	}
	
	
	// 트랜잭션 확인을 위한 testTransaction() 메소드를 호출하는 매핑 작성
	// http://localhost:9090/app08/brd/transaction 입력해서 동작 확인
