...
public class MyController1 {
	...
	// <a href="${contextPath}/member/detail1?id=admin&pw=1234">
	...
	// location.href='${contextPath}/member/detaile2?id=admin&pw=1234';
	@GetMapping("detail2")
	...
	// location.href='${contextPath}/member/detaile3?id=admin&pw=1234';
	@GetMapping("detail3")
	public String detaile3(String id // @RequestParam은 생략할 수 있다. 파라미터 id가 없는 경우 null이 저장된다.
			             , String pw // @RequestParam은 생략할 수 있다. 파라미터 가 없는 경우 null이 저장된다.
			             , Model model) {
		Member member = new Member(id, pw);
	...
	@GetMapping("detail4")
	public String getDetail4(Member member  // 파라미터 id, pw를 setId() 메소드, setPw()를 이용해서 member 객체에 저장해 준다.
			               , Model model) {
	...
	public String postDetail(@ModelAttribute(value="member") Member member) { // 파라미터 id, pw를 이용해 Member member를 만들고, Model에 member라는 이름의 속성으로 저장하시오.
