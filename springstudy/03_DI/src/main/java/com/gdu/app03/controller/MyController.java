...
public class MyController {
	...
	*/
	...
	/*
	@Autowired
	private Board board; // class를 보고 가져온다.
	*/
	...
	/*
		...
		@Autowired
		private Board board; // 타입이 Board인 Bean을 Container에서 가져와라
		
		----- Container ---------------
		<bean id="board" class="Board">
		-------------------------------
	*/
	...
	*/
	...
	public void setBoard(Board board) { // 매개변수 Board board로 Board 타입의 Bean을 Container에서 가져와라
		this.board = board;
	}
	*/
