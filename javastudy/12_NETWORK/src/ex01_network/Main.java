...
public class Main {
	...
	public static void m2() {
		...
		// 4. URL 클래스의 opneConnetction() 메소드를 호출해서 HttpURLConnectino 클래스 타입으로 저장
		...
		try {
			...
			System.out.println("컨텐트 타입 : " + con.getContentType()); // 자주 사용
			System.out.println("요청방식 : " + con.getRequestMethod());
	...
	public static void m3() {
		...
		try {
			...
			// StringBuilder의 모든 내용 C:\\storage\\naver.html 로 내보내기
