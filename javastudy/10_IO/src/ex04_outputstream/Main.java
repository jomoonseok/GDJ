...
public class Main {
	...
	public static void m1() {
		...
		try {
			...
			// getBytes() 메소드 String을 byte타입으로 바꿔준다.
	...
	public static void m3() {
		...
		// BufferedOutputStream과 같은 보조 Stream
		// 따라서 메인 Stream이 필요하다.
		...
		try {
			...
			String name = "에밀리";
			int age = 30;
			double height = 165.5; // 타입이 맞지 않아서 DataOutputStream이 아니면 출력하기 힘들다.

			// 출력
			dos.writeUTF(name); // writeUTF() 메소드 String을 UTF-8 방식으로 출력해준다.
			dos.writeInt(age);
