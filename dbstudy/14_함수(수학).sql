...
SELECT 
       CEIL(1.111 * POWER(10, 1)) / POWER(10, 1)
     , CEIL(1.111 * POWER(10, 2)) / POWER(10, 2)
     , CEIL(11111 * POWER(10, -1)) / POWER(10, -1)
     , CEIL(11111 * POWER(10, -2)) / POWER(10, -2)
  FROM
       DUAL;

-- 2. 원하는 자릿수로 내림
--    CEIL 대신 FLOOR 함수를 사용하면 된다.
