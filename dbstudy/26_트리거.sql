...
CREATE OR REPLACE TRIGGER TRIG1
    ...
    FOR EACH ROW  -- UPDATE는 행마다 트리거가 동작함
BEGIN
...
CREATE OR REPLACE TRIGGER TRIG2
    AFTER
    INSERT OR UPDATE OR DELETE -- 순서상관없다.
    ON DEPARTMENT
    FOR EACH ROW
BEGIN
    IF INSERTING THEN
...
BEGIN
    ...
    VALUES
        (RETIRE_SEQ.NEXTVAL, TO_CHAR(SYSDATE, 'YY/MM/DD'), :OLD.EMPLOYEE_ID, :OLD.FIRST_NAME, :OLD.LAST_NAME, :OLD.EMAIL, :OLD.PHONE_NUMBER, :OLD.HIRE_DATE, :OLD.JOB_ID, :OLD.SALARY, :OLD.COMMISSION_PCT, :OLD.MANAGER_ID, :OLD.DEPARTMENT_ID);
END RETIRE_TRIG;
